...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        UserDTO user1 = new UserDTO("John", "Kesy",
                "admin@gmail.com", "abc", true, "7459684532", admin, Gender.MALE);
        UserDTO user5 = new UserDTO("John", "Kesy",
                "admin2@yahoo.com", "abc", true, "7459684532", admin, Gender.MALE);
        UserDTO user2 = new UserDTO("Delisa",
                "Norre", "T001@gmail.com", "123", true, "8567412358", manager, Gender.MALE);
        UserDTO user3 = new UserDTO("Craig", "Jark",
                "P001@hotmail.com", "123", true, "7777775566", employee, Gender.MALE);
        UserDTO user4 = new UserDTO("Shaun",
                "Hayns", "S001@mail.com", "123", true, "3256987412", employee, Gender.MALE);
